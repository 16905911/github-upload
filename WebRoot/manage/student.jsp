...
<table width="96%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
  <tr align="center" bgcolor="#A8D8FC">
    <td width="20%" height="30" bgcolor="#B2D6F1">准考证号</td>
    <td width="15%" bgcolor="#B2D6F1">学号</td>
    <td width="12%" bgcolor="#B2D6F1">姓名</td>
	<td width="10%" bgcolor="#B2D6F1">性别</td>
	<td width="11%" bgcolor="#B2D6F1">专业</td>
	<td width="25%" bgcolor="#B2D6F1">注册时间</td>	    
    <td width="7%" bgcolor="#B2D6F1">选项</td>
  </tr>
	<logic:iterate id="student" name="studentQuery" type="com.oes.actionForm.StudentForm" scope="request">
  <tr>
    ...
    <td style="padding:5px;" align="center"><bean:write name="student" property="name" filter="true"/></td>
	<td align="center"><bean:write name="student" property="sex" filter="true"/></td>
	<td align="center"><bean:write name="student" property="profession" filter="true"/></td>
