...
function checkForm(form){
	...
	if(form.newpwd1.value==""){
		alert("请输入确认新密码!");form.newpwd1.focus();return false;
	}	
...
<logic:iterate id="manager" name="pwdQueryif" type="com.oes.actionForm.ManagerForm" scope="request">
...
<html:form action="/manage/manager.do?action=modifypwd" method="post" focus="oldpwd1" onsubmit="return checkForm(managerForm)">
  ...
  <tr align="center">
    ...
    <td width="73%" align="left">
      <html:text property="name" value="<%=managerName%>" readonly="true" size="30"/><font color="#FF0000"> （只读）</font>    </td>
	  </tr>
    <tr>
    <td align="left" style="padding:5px;">原密码：</td>
    <td align="left"><html:password styleId="oldpwd1" property="oldpwd" size="30"/><font color="#FF0000"> *</font>
      <html:hidden styleId="holdpwd" property="oldpwd" value="<%=managerPwd%>"/></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;">新密码：</td>
      <td align="left"><html:password styleId="newpwd"  property="pwd" size="30"/><font color="#FF0000"> *</font></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;">确认新密码：</td>
      <td align="left"><html:password styleId="newpwd1" property="pwd" size="30"/><font color="#FF0000"> *</font></td>
    </tr>
    <tr>
