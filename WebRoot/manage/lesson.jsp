    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="570"  border="0" cellpadding="0" cellspacing="0" align="right">
      <tr>
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="78%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">科目信息管理  &gt;&gt;&gt;</span></td>
...
<table width="96%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="10%"><html:link page="/manage/lesson.do?action=lessonAddQuery">添加科目</html:link></td>
  </tr>
</table>
...
<html:form action="/manage/lesson.do?action=lessonDel" method="post">
  <tr align="center" bgcolor="#A8D8FC">
  	<!--<td width="10%" bgcolor="#B2D6F1">编号</td>-->
    <td width="40%" height="30" bgcolor="#B2D6F1">科目名称</td>
    <td width="15%" bgcolor="#B2D6F1">考场状态</td>
	<td width="30%" bgcolor="#B2D6F1">加入时间</td>
  ...
  <tr>
    ...
    <td align="center"><html:button property="button" styleClass="btn_grey" value="查看" 
	...
	<td align="center"><html:link page="/manage/lesson.do?action=lessonModifyQuery" paramId="id" paramName="lesson" paramProperty="ID">修改</html:link></td>
...
<table width="94%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
	<td width="70%" height="24" align="center"><font color=red>* 温馨提示：添加考试科目后，需添加试卷信息和题目信息才能查看试卷</font></td>
