...
<jsp:useBean id="taoTi" class="com.oes.dao.QuestionsDAO" scope="page"/>
<!-- 
	管理员操作，考试题目显示页面
-->
<html>
    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="570"  border="0" cellpadding="0" cellspacing="0" align="right">
      <tr>
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="78%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">题目信息管理  &gt;&gt;&gt;</span></td>
...
<html:form action="/manage/questions.do?action=questionsDel" method="post">
  <tr align="center" bgcolor="#A8D8FC">
	<td width="20%" height="30" bgcolor="#B2D6F1">所属科目</td>
    <td width="26%" bgcolor="#B2D6F1">所属试卷</td>
	<td width="33%" bgcolor="#B2D6F1">题目名称</td>
	<td width="9%" bgcolor="#B2D6F1">试题类型</td>
	<td width="6%" bgcolor="#B2D6F1">修改</td>
	<td width="6%" bgcolor="#B2D6F1">选项</td>
  </tr>
	<logic:iterate id="questions" name="questionsQuery" type="com.oes.actionForm.QuestionsForm" scope="request">
