    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="570"  border="0" cellpadding="0" cellspacing="0" align="right">
      <tr>
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="78%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">题目信息管理 &gt; 添加考试题目 &gt;&gt;&gt;</span></td>
...
<html:form action="/manage/questions.do?action=questionsAdd" method="post" onsubmit="return checkForm(questionsForm)">
  ...
  <tr align="center">
    ...
    <td width="85%" align="left">
      <html:text property="subject" size="40"/><font color="#FF0000"> *</font>
	  </td>
    <tr>
    <tr>
    ...
    <td width="85%" align="left">
      <html:text property="optionA" size="40"/><font color="#FF0000"> *</font>
	  </td>
    </tr>
	  <tr align="center">
    <td width="15%" height="30" align="left" style="padding:5px;">选项B：</td>
    <td width="85%" align="left">
      <html:text property="optionB" size="40"/><font color="#FF0000"> *</font>
	  </td>
    </tr>
	  <tr align="center">
    <td width="15%" height="30" align="left" style="padding:5px;">选项C：</td>
    <td width="85%" align="left">
      <html:text property="optionC" size="40"/><font color="#FF0000"> *</font>
	  </td>
    </tr>
  <tr align="center">
    <td width="15%" height="30" align="left" style="padding:5px;">选项D：</td>
    <td width="85%" align="left">
      <html:text property="optionD" size="40"/><font color="#FF0000"> *</font>
	  </td>
    </tr>
    <tr align="center">
