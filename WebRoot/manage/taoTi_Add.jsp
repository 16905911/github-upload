    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="570"  border="0" cellpadding="0" cellspacing="0" align="right">
      <tr>
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="78%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">试卷信息管理 &gt; 添加试卷信息 &gt;&gt;&gt;</span></td>
...
<html:form action="/manage/taoTi.do?action=taoTiAdd" method="post" onsubmit="return checkForm(taoTiForm)">
  ...
  <tr align="center">
   <tr>
    ...
    <td align="left"><html:select property="lessonId"><html:options collection="lessonList" property="ID" labelProperty="name"/>
	 </html:select>
     </td>
    </tr>
