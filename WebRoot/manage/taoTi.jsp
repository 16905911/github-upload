    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="570"  border="0" cellpadding="0" cellspacing="0" align="right">
      <tr>
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="78%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">试卷信息管理  &gt;&gt;&gt;</span></td>
...
<table width="96%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="10%"><html:link page="/manage/taoTi.do?action=taoTiAddQuery">添加试卷</html:link> </td>
  </tr>
</table>
...
<html:form action="/manage/taoTi.do?action=taoTiDel" method="post">
  <tr align="center">
    <td width="29%" height="30" bgcolor="#B2D6F1">试卷名称</td>
	<td width="25%" bgcolor="#B2D6F1">所属科目</td>
	<td width="32%" bgcolor="#B2D6F1">加入时间</td>
	<td width="7%" bgcolor="#B2D6F1">修改</td>
	<td width="7%" bgcolor="#B2D6F1">选项</td>
  </tr>
	<logic:iterate id="taoTi" name="taoTiQuery" type="com.oes.actionForm.TaoTiForm" scope="request">
